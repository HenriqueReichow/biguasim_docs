...
and BiguaSim. This allows you to use ROS2 to control BiguaSim agents and publish sensor data to 
ROS2 topics. 
...
BiguaSim supports publishing data to LCM (Lightweight Communications and Marshalling), a messaging
...
for options on this. If no provider is specified, BiguaSim uses the default LCM udqm.
...
Once the provider is chosen, BiguaSim publishes each sensor individually. The lcm_channel is 
