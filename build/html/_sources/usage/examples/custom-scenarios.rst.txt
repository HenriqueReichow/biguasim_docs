...
BiguaSim worlds are meant to be configurable by changing out the scenario
(see :ref:`scenarios`). There are some scenarios included with BiguaSim
packages distributed as ``.json`` files, but BiguaSim is intended to be used
