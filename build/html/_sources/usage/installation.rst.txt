...
the BiguaSim project, which integrates Unreal Engine 5 (UE5) and the BiguaSim client. 
...
The provided Docker containers enable both development and runtime workflows for BiguaSim. 
The Python/client development container is designed for interactive development and compilation of BiguaSim, limited to changes of Python source code, 
whereas the runtime container is intended for executing pre-built BiguaSim applications
